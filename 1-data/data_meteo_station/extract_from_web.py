...
def main():
    ...
    try:
        ...
        username_input = wait.until(EC.presence_of_element_located((By.ID, "id_account_name")))
        print("[*] Username input found (id='id_account_name').")
        password_input = driver.find_element(By.ID, "id_account_password")
        ...
        for day in all_days:
            ...
            # Node select
            node_select = Select(driver.find_element(By.ID, "node_select"))
